  ...
  render() {
    ...
    switch (this.state.target) {
      case 1:
        ...
        break;
      case 2:
        target = <Block ><HisBlock><p>กระต่าย</p> <p> คือสัญลักษณ์ของความอุดมสมบูรณ์ และเปรียบเสมือนผู้ส่งสารของอีสเตอร์ กระต่ายเข้ามาเกี่ยวข้องกับเทศกาลอีสเตอร์นับตั้งแต่ศตวรรษที่ 18</p></HisBlock></Block>;
        break;
      case 3:
        ...
        break;
      case 4:
        target = <Block><HisBlock><p>เทียนปัสกา (Paschal Candle)</p> <p>เทียนสีขาวขนาดใหญ่ ชาวคริสต์จะเริ่มฉลองเทศกาล ด้วยการจุดเทียนปัสกา เพื่อรำลึกถึงการฟื้นคืนชีพแสงสว่างที่ออกมาจากอุโมงค์ที่มืดมิด</p></HisBlock></Block>;
        break;
      case 5:
